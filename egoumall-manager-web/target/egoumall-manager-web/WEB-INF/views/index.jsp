...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../../resources/js/jquery-easyui-1.4.1/themes/gray/easyui.css"/>
    <link rel="stylesheet" type="text/css" href="../../resources/js/jquery-easyui-1.4.1/themes/icon.css"/>
    <link rel="stylesheet" type="text/css" href="../../resources/css/egoumall.css"/>
...
<div data-options="region:'north',border:false" style="height:60px; padding:5px; background:#F3F3F3">
    <span class="northTitle">易购商城后台管理系统</span>
